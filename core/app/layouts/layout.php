    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>SYSTEM</b>RACLIMA</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="https://www.facebook.com/Amilcar.CaceresH/" target="_blank" class="">Ir a Pag. Amilcar</a>
                      <a href="https://www.facebook.com/Amilcar.CaceresH/" target="_blank" class="">Ver a Maximo</a>
                  </li>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2017 <a href="https://www.facebook.com/Amilcar.CaceresH/" target="_blank">Amílcar</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
      <a href="./">SYSTEM<b>RACLIMA</b></a>
      </div><!-- /.login-logo -->
