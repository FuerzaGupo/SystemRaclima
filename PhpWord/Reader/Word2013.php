 ...
 */
class Word2013 extends AbstractReader implements ReaderInterface
{
    /**
    ...
    {
        $partClass = "PhpOffice\\PhpWord\\Reader\\Word2013\\{$partName}";
        if (class_exists($partClass)) {
            /** @var \PhpOffice\PhpWord\Reader\Word2013\AbstractPart $part Type hint */
