...
namespace PhpOffice\PhpWord\Writer\Word2013\Style;
...
abstract class AbstractStyle
{
    ...
    {
        if ($value !== null) {
            $class = "PhpOffice\\PhpWord\\Writer\\Word2013\\Style\\" . $name;

            /** @var \PhpOffice\PhpWord\Writer\Word2013\Style\AbstractStyle $writer */
